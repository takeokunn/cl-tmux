...
(defun apply-named-layout (window layout-name)
  ...
  (let* ((panes (window-panes window))
    ...
    (ecase layout-name
      ...
      (:even-horizontal
       ;; n equal-width columns separated by 1-col borders.
       (let* ((avail-w (- w (1- n)))
      ...
      (:even-vertical
       ;; n equal-height rows separated by 1-row borders.
       (let* ((avail-h (- h (1- n)))
      ...
      (:main-horizontal
       ;; First pane: top half.  Rest split bottom half equally.
      ...
      (:main-vertical
       ;; First pane: left half.  Rest split right half equally stacked.
      ...
      (:tiled
       ...
       ;; Build a row-major tree: vertical chain of horizontal rows.
       ;; pane-reposition sets the actual geometry; the tree structure mirrors it.
