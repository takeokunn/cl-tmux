...
(defparameter *arg-command-table*
   ...
   (cons '("show-options" "show" "show-option")
         #'%cmd-show-options-arg)
   (cons '("show-window-options" "showw")
         #'%cmd-show-window-options-arg)
   (cons '("show-session-options" "shows")
         #'%cmd-show-session-options-arg)
   (cons '("show-server-options")
