...
(describe "dispatch-suite"
  ...
  (it "run-command-line-select-layout-known-layouts-do-not-error"
  ...
  (it "run-command-line-list-clients-target-session-context"
  ...
  (it "run-command-line-list-sessions-filter-matches-expanded-rows"
    (with-fake-session (s1 :nwindows 1 :npanes 1)
      (let ((s2 (make-fake-session :nwindows 1 :npanes 1)))
        (with-session-and-window-names (s1 "alpha")
          (with-session-and-window-names (s2 "beta")
  ...
  (it "run-command-line-list-panes-shows-overlay"
    (with-fake-two-pane-session (s)
  ...
  (it "run-command-line-list-panes-format-uses-arg-handler"
    (with-fake-two-pane-session (s)
  ...
  (it "run-command-line-list-panes-targets-window"
  ...
  (it "run-command-line-list-panes-all-sessions"
    (with-fake-session (s1 :nwindows 1 :npanes 1)
      (let ((s2 (make-fake-session :nwindows 1 :npanes 1)))
  ...
  (it "run-command-line-list-panes-session-scope"
    (with-fake-session (s :nwindows 2 :npanes 1)
      (let ((wins (session-windows s)))
  ...
  (it "run-command-line-list-panes-filter-matches-expanded-rows"
    (with-fake-two-pane-session (s)
      (with-run-command-line-overlay
  ...
  (it "run-command-line-list-windows-format-uses-arg-handler"
    (with-fake-session (s :nwindows 2 :npanes 1)
  ...
  (it "run-command-line-list-windows-targets-session"
    (with-fake-session (s1 :nwindows 1 :npanes 1)
      (let ((s2 (make-fake-session :nwindows 1 :npanes 1)))
  ...
  (it "run-command-line-list-windows-all-sessions"
    (with-fake-session (s1 :nwindows 1 :npanes 1)
      (let ((s2 (make-fake-session :nwindows 1 :npanes 1)))
        (with-session-and-window-names (s1 "alpha" "home")
          (with-session-and-window-names (s2 "beta" "work")
  ...
  (it "run-command-line-list-windows-all-sessions-falls-back-to-current"
    (with-fake-session (s :nwindows 1 :npanes 1)
  ...
  (it "run-command-line-list-windows-filter-matches-expanded-rows"
    (with-fake-session (s :nwindows 2 :npanes 1)
      (with-window-names (s "home" "work")
        (with-run-command-line-overlay
