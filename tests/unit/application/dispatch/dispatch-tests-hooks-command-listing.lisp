...
(describe "dispatch-suite"
  ...
  (it "cmd-list-commands-resolves-prefixes-and-reports-ambiguity"
    (with-fake-session (s)
  ...
  (it "cmd-list-commands-format-canonical-fields"
    (with-fake-session (s)
  ...
  ;; output.
  (it "cmd-list-commands-unsupported-arguments-are-rejected-before-output"
    (with-fake-session (s)
