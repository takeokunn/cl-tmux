...
;;; attach-session flag parsing: %parse-attach-flags is defined by define-flag-parser
;;; in src/bootstrap/main.lisp and is exhaustively table-tested in main-tests.lisp
;;; (parse-attach-flags-order-independent, define-flag-parser-value-flag-advances-index,
;;; define-flag-parser-bool-flag-does-not-advance-past-flag,
;;; define-flag-parser-unknown-flag-at-end-does-not-error) — no duplicate test here.
...
;;; function (which is built by define-msg-dispatch) directly and checking that
;;; its COND arms are structurally correct — the same contract tested by
;;; handle-client-message-simple-returns-table above.
